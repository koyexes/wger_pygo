...
class IngredientListView(ListView):
    ...
    def get_queryset(self):
        ...
        (the user can also want to see ingredients in English,
         in addition to his
...
class IngredientCreateView(IngredientMixin, CreateView):
    ...
    def form_valid(self, form):
        ...
        if self.request.user.has_perm('nutrition.add_ingredient'):
            ...
            message = _(u'''The user {0} submitted a new ingredient "{1}".'''.
                        format(self.request.user.username, form.instance.name))
    ...
    def dispatch(self, request, *args, **kwargs):
        ...
        return super(IngredientCreateView, self).dispatch(request, *args,
                                                          **kwargs)
