...
def trainer_login(request, user_pk):
    ...
    own = False
    if (user.has_perm('gym.gym_trainer') or user.has_perm('gym.manage_gym') or
    ...
    #     auth/default/#auth-web-requests
...
class UserDeactivateView(LoginRequiredMixin,
    ...
    def dispatch(self, request, *args, **kwargs):
        ...
        return super(UserDeactivateView, self).dispatch(request, *args,
                                                        **kwargs)
...
class UserListView(LoginRequiredMixin, PermissionRequiredMixin, ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['user_table'] = {
            'keys':
            [_('ID'), _('Username'), _('Name'), _('Last activity'), _('Gym')],
            'users':
