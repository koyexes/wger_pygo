...
# flake8 flagged an unused import error for django.conf.urls
# but other variables are dependent on it here.
...
patterns_user = [
    ...
    # no need to cook our own soup here (besides the templates)
    ...
    url(
        r'^password/reset/check/(?P<uidb64>[0-9A-Za-z_\-]+)/(?P<token>[0-9A-Za-z]{1,13}-[0-9A-Za-z]{1,20})$',
