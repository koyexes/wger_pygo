...
# flake8 flags url resolvers as unused but some functions
# are dependent on some of its methods
...
'''flagged as unused by flake8 but its methods are needed here.'''
