...
def render_workout_day(day, nr_of_weeks=7, images=False, comments=False,
                       only_table=False):
    '''
    ...
    for set in day['set_list']:
        group_exercise_marker[set['obj'].id] = {'start': len(data),
                                                'end': len(data)}
        ...
        for exercise in set['exercise_list']:
            ...
            if exercise['has_weight']:
                ...
                for i in exercise['setting_text'].split(u'–'):
                    setting_out.append(Paragraph(i, styleSheet["Small"],
                                                 bulletText=''))
            else:
            ...
            if comments:
                item_list = [ListItem(Paragraph(i, style=styleSheet[
                    "ExerciseComments"]))
            ...
            exercise_content = [Paragraph(exercise['obj'].name,
                                          styleSheet["Small"]),
                                image,
    ...
    # The rows with exercises range from exercise_start till
...
def reps_smart_text(settings, set_obj):
    ...
    repetitionand weight units as appropriate,
     e.g. "8 x 2 Plates", "10, 20, 30, ∞"
