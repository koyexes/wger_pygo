...
def export_pdf(request, id, uidb64=None, token=None):
    ...
    * http://www.reportlab.com/apis/reportlab/dev/platypus.html
    ...
    data.append([
        Paragraph(_('Energy'), styleSheet["Normal"]), Paragraph(
            six.text_type(plan_data['total']['energy']), styleSheet["Normal"])
    ])
    data.append([
        Paragraph(_('Protein'), styleSheet["Normal"]), Paragraph(
            six.text_type(plan_data['total']['protein']),
            styleSheet["Normal"]), Paragraph(
    ...
    data.append([
        Paragraph(_('Carbohydrates'), styleSheet["Normal"]), Paragraph(
    ...
    data.append([
        Paragraph(_('Fat'), styleSheet["Normal"]), Paragraph(
    ...
    data.append([
        Paragraph(_('Fibres'), styleSheet["Normal"]), Paragraph(
            six.text_type(plan_data['total']['fibres']), styleSheet["Normal"])
    ])
    data.append([
        Paragraph(_('Sodium'), styleSheet["Normal"]), Paragraph(
