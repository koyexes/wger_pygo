...
class ScheduleModelTestCase(WorkoutManagerTestCase):
    ...
    def create_schedule(self, user, start_date=datetime.date.today(),
                        is_loop=False):
        '''
        Helper function
        '''
    ...
    def test_get_workout_steps_test_4(self):
        '''
        Test with 3 steps. Start is too far in the past, schedule
        is not a loop
        '''
        self.user_login('test')
        user = User.objects.get(pk=2)
...
class SchedulePdfExportTestCase(WorkoutManagerTestCase):
    ...
    def export_pdf_with_comments(self, fail=False, pdf_type="log"):
        '''
        Helper function to test exporting a workout as a pdf, with
        exercise coments
        '''
    ...
    def export_pdf_with_images_and_comments(self, fail=False, pdf_type="log"):
        '''
        Helper function to test exporting a workout as a pdf, with images
        and comments
        '''
    ...
    def test_export_pdf_log_other(self):
        '''
        Tests exporting a workout as a pdf as a logged user not owning
        the data
        '''
    ...
    def test_export_pdf_log_with_images_and_comments(self, fail=False):
        '''
        Tests exporting a workout as a pdf as the owner user with
        images andcomments
        '''
        self.user_login('test')
...
#   #####TABLE#####
    ...
    def test_export_pdf_table_other(self):
        '''
        Tests exporting a workout as a pdf as a logged user not
        owning the data
        '''
